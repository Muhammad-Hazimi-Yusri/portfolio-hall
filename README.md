...
> ⚠️ **Theme TBD** — Final name and visual direction pending domain availability.

| Name Option | Visual Direction |
|-------------|------------------|
| Glass House / Rumah Kaca | Modern minimalist, lots of light, clean lines |
| Istana / Balairung | Royal castle hall, ornate, warm lighting, rich textures |
| Galeri | Clean gallery aesthetic, white walls, spotlight focus |
| Dewan | Formal hall, wood tones, traditional elements |

Theme choice affects:
- 3D asset style (modern vs ornate)
- Color palette
- Typography
- UI component styling
- Fallback mode aesthetics
...
Copyright © 2024-present Muhammad Hazimi Yusri
