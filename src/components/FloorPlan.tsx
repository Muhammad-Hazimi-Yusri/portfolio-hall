...
export function FloorPlan({ pois, selectedSection, onSelectPOI }: FloorPlanProps) {
  ...
  return (
    <svg viewBox="-10 -12 20 16" className="w-full h-full max-h-[60vh]">
      {/* Hall outline */}
      <rect x="-8" y="-10" width="16" height="14" fill="none" stroke="currentColor" strokeWidth="0.2" className="text-hall-muted" />
      
      {/* Door */}
      <rect x="-1" y="3.9" width="2" height="0.3" className="fill-hall-accent" />
