// Self-hosted flag-icons 7.3.2 assets. See public/flags/README.md and LICENSE.
...
export function countryFlagUrl(country: string): string | null {
  ...
  if (!available.has(code) || code === 'xx') return null
  return `${import.meta.env.DEV ? '/' : import.meta.env.BASE_URL}flags/${code}.svg`
}
